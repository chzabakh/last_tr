...
const Messages: React.FC<ChatProps> = ({ dm, updateItem }) => {
  ...
  return (
    <div className="overflow-y-auto overflow-x-hidden flex flex-col border-2 h-[90%] sm:h-full w-full sm:w-[77%] border-opacity-30 border-violet-400 bg-opacity-5 bg-gradient-to-l from-[rgba(255,255,255,0.20)] bg-transparent bg-blur-md backdrop-filter backdrop-blur-md rounded-[30px]">
      {isLoading ? (
        <p>Loading...</p>
      ) : (
        <>

  ...
  return (
    <>
     <label htmlFor="channel" className="block mb-2 text-sm font-medium text-white dark:text-white">Channel name:</label>
      <input type="text" id="channelName" className="focus:border-none outline-none  border-gray-300 text-white/60 text-sm rounded-lg p-3 w-full bg-black/40" placeholder="Enter name..." value={roomName} onChange={handleName} required></input>
      <p className='text-sm'>Channel password:</p>
      <input type="password" id="channelPassword" className="focus:border-none outline-none  border-gray-300 text-white/60 text-sm rounded-lg p-3 w-full bg-black/40" placeholder="Enter password..." value={password} onChange={handlePassword} required></input>

...
const Chat = () => {
  ...
  return (
    <>
      {/* <DashboardLayout> */}
        <div className="min-h-[500px] w-full items-center justify-center my-20 h-[80%] gap-3 flex flex-row pw-[85%] mx-[2rem] border-2  border-opacity-30 border-violet-400 bg-opacity-20 bg-black bg-blur-md backdrop-filter backdrop-blur-md p-4 rounded-[30px]">
